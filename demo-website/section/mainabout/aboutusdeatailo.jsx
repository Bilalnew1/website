      ...
      <div className="bg-blue-800 py-6">
        ...
        <div className="lg:grid grid-cols-2 gap-1 w-[80%] mx-auto">
          <div className="text-white my-5 lg:my-0">
            <h1 className="text-[56px] font text-4xl sm:text-6xl"> Backend </h1>
            <p className="mt-4 text-xl ">
              ...
              solutions. Be it your website, web application or E-Store, we
              cover it all for you. We secure the frontend results with
              structured backend code that completely fulfills customer
              requirements.
            </p>{" "}
          </div>
...
export default aboutusdeatailo
